...
class MultiPointTest {
    ...
    @Test
    void serialization_withLongitudeAndLatitude_shouldProvideValidJson() {
        ...
        String jsonContent = JSON_MAPPER.writeValueAsString(multiPoint);
    ...
    @Test
    void serialization_withLongitudeAndLatitudeAndAltitude_shouldProvideValidJson() {
        MultiPoint multiPoint = MultiPoint.of(
    ...
    void deserialization_withValidLongitudeAndLatitude_shouldCreateValidObject() {
        ...
        assertThat(JSON_MAPPER.readValue(json, MultiPoint.class)).isNotNull()
    ...
    @Test
    void deserialization_withValidLongitudeAndLatitude_withGeometryBaseType_shouldCreateValidObject() {
        String json = """
                { "type": "MultiPoint", "coordinates": [ [100.0, 0.0], [101.0, 1.0] ] }""";
    ...
    void deserialization_withValidLongitudeAndLatitude_withGeoJsonBaseType_shouldCreateValidObject() {
        ...
        GeoJson geoJson = JSON_MAPPER.readValue(json, GeoJson.class);
    ...
    @Test
    void deserialization_withValidLongitudeAndLatitudeAndAltitude_shouldProvideValidObject() {
        String json = """
    ...
    @Test
    void deserialization_withValidLongitudeAndLatitudeAndAltitude_withGeometryBaseType_shouldProvideValidObject() {
        String json = """
                { "type": "MultiPoint", "coordinates": [ [100.0, 0.0, 5.0], [101.0, 1.0, 5.0] ] }""";
    ...
    @Test
    void deserialization_withValidLongitudeAndLatitudeAndAltitude_withGeoJsonBaseType_shouldProvideValidObject() {
        String json = """
                { "type": "MultiPoint", "coordinates": [ [100.0, 0.0, 5.0], [101.0, 1.0, 5.0] ] }""";
    ...
    @CsvSource(quoteCharacter = '"', delimiter = ';', textBlock = """
            ...
            """)
    void deserialization_withInvalidJson_shouldCreateObject_withInvalidStatus(String geoJson, String expectedErrorKey) {
        assertThat(JSON_MAPPER.readValue(geoJson, MultiPoint.class))
    ...
    @CsvSource(quoteCharacter = '"', delimiter = ';', textBlock = """
            ...
            { "type": "MultiPoint", "coordinates": [ [100.0, 100.0, 5.0], [101.0, 100.0, 5.0] ] };  coordinates.latitude.invalid
            """)
    void deserialization_withInvalidJson_withGeometryBaseType_shouldCreateObject_withInvalidStatus(String geoJson, String expectedErrorKey) {
        assertThat(JSON_MAPPER.readValue(geoJson, Geometry.class))
                .satisfies(point -> assertThat(point.getType()).isEqualTo("MultiPoint"))
                .satisfies(point -> assertThat(point.isValid()).isFalse())
                .satisfies(point -> assertThat(point.validate())
                                .satisfies(validationResult -> assertThat(validationResult.hasErrors()).isTrue())
    ...
    @CsvSource(quoteCharacter = '"', delimiter = ';', textBlock = """
            ...
            { "type": "MultiPoint", "coordinates": [ [100.0, 100.0, 5.0], [101.0, 100.0, 5.0] ] };  coordinates.latitude.invalid
            """)
    void deserialization_withInvalidJson_withGeoJsonBaseType_shouldCreateObject_withInvalidStatus(String geoJson, String expectedErrorKey) {
        assertThat(JSON_MAPPER.readValue(geoJson, GeoJson.class))
                .satisfies(point -> assertThat(point.getType()).isEqualTo("MultiPoint"))
                .satisfies(point -> assertThat(point.isValid()).isFalse())
                .satisfies(point -> assertThat(point.validate())
                                .satisfies(validationResult -> assertThat(validationResult.hasErrors()).isTrue())
