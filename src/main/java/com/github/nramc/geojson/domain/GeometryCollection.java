 ...
 *
 * <p>A GeometryCollection is used in GeoJSON to group different geometry types, such as points, lines, and polygons.
 * Each geometry in the collection must be a valid GeoJSON geometry, and nested GeometryCollections are not allowed.
 * </p>
 *
 * <p>This class supports validation through the {@link Validatable} interface to ensure GeoJSON compliance.
 * </p>
 *
 * <p>Note: The class is immutable, and all collections are unmodifiable to ensure thread-safety and immutability.
 *
 * <p>Usage Example:</p>
 *
 * <pre>{@code
...
public final class GeometryCollection extends Geometry {
     ...
     *
     * <p>This constructor does not perform any validation. It is recommended to call
     ...
     *
     * <p>This constructor is used to create a GeometryCollection with the specified GeoJSON type and geometries. The
     ...
     *
     * <p>The method validates the created GeometryCollection using {@link ValidationUtils#validateAndThrowErrorIfInvalid(Validatable)}.
     ...
     *
     * <p>If the provided array is not empty, the method creates a list from the geometries; otherwise,
     ...
     *
     * <p>The format includes the type of the geometry and the list of geometries it contains.
     *
     ...
     *
     * <p>The hash code is calculated using the hash codes of the {@code type}
